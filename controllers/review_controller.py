...
# all urls  (user paths):
   # Get method: /api/v1/review/<int:user_id>/<int:mobile_id>   (to get the ratings given by a user for a mobile)
   # Post method: /api/v1/review/<int:user_id>/<int:mobile_id>  (to give the ratings by a user for a mobile)
   # Delete method: /api/v1/review/<int:user_id>/<int:review_id>   (to delete a particular review bsed on user_id and review_id)
...
@reviews_blueprint.route('review/<int:user_id>/<int:review_id>', methods=['DELETE'])
